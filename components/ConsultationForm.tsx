  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      for (let i = 0; i < formData.images.length; i++) {
        ...
        // Transform image through internal API to keep Gemini key server-side
        ...
        let transformData: { transformedUrl?: string; error?: string; message?: string; warning?: string } | null = null;
        try {
